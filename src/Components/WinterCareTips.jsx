...
const WinterCareTips = () => {
    return (
        <div className='pb-20 bg-orange-100 px-3 w-11/12 mx-auto'>
            <h2 className='text-3xl font-bold text-center pt-15 pb-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 pb-10 gap-10'>
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-3 border-r-2 border-orange-300 pr-5'>
                        <div className='space-y-1'>
                            ...
                            <p className='text-gray-500 border-b border-dashed border-orange-200'>Provide insulated bedding away from drafts.</p>
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-3 border-r-2 border-orange-300 pr-5'>
                        <div className='space-y-1'>
                            ...
                            <p className='text-gray-500 border-b border-dashed border-orange-200'>Avoid icy sidewalks and areas treated with salt.</p>
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-3'>
                        <div className='space-y-1'>
                            ...
                            <p className='text-gray-500 border-b border-dashed border-orange-200'>Ensure pets have fresh water at all times.</p>
