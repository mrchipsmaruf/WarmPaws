    ...
    return (
        <div className='flex justify-center items-center text-center'>
            <div className='bg-orange-50 rounded-4xl p-10'>
                ...
                <h2 className='pb-3'>to <span className='text-5xl font-bold'>Warm<span className='text-orange-400'>Paws</span></span></h2>
                <div>
                    <form onSubmit={handleLogin} className='space-y-3 pt-20 w-[600px] h-[500px]'>
                        ...
                        {
                            error && <p className='text-red-500 text-sm font-semibold'>User doesn't exist please create an account</p>
                        }
                        ...
                        <button onClick={handleGoogleLogin} className='btn w-full bg-white hover:bg-orange-400  hover:text-white rounded-4xl'><FcGoogle></FcGoogle> Continue with Google</button>
